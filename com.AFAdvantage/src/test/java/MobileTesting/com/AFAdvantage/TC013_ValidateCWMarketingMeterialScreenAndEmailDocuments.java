...
public class TC013_ValidateCWMarketingMeterialScreenAndEmailDocuments extends TestBase {	
	Homepage hm;
	Resourcespage res;
	...
	public void validateCWMarketingMeterialAndEmailAFSpecificInfo(String firstname, String lastname, String email, String testMode) throws InterruptedException {
