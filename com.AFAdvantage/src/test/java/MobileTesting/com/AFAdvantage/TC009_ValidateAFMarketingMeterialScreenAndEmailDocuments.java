...
public class TC009_ValidateAFMarketingMeterialScreenAndEmailDocuments extends TestBase {
	...
	public void validateAFMarketingMeterialAndEmailAFSpecificInfo(String firstname, String lastname, String email, String testMode) throws InterruptedException {
		...
		//Open AF at a glance pdf document.
		res.openAFAtAGlanceDoc();		
	...
	/*@Test(dependsOnMethods = {"validateAFMarketingMeterialAndEmailAFSpecificInfo"})
	public void validateCWMarketingMeterialAndEmailAFSpecificInfo() throws InterruptedException {
		...
		Assert.assertEquals(res.filtersBannerDisplayed(), true);		
		res.closeFilterScreen();
		//Open Discover the difference pdf document.
		res.openDiscoverTheDifferenceDoc();		
		// Select all materials documents and email them.
		res.selectAllMaterialsDocAndEmail();
		test.log(LogStatus.PASS, "Material documents are emailed successfully.");
